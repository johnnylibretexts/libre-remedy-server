"""PPTX decorative-skip proxy backed by OOXML decorative flags."""
...
from project_remedy.behavioral_proxies.office._ooxml import is_pptx_slide_part
...
class PPTXDecorativeSkipTest:
    ...
    def run(self, artifact_path: Path, **kwargs: Any) -> BehavioralTestResult:
        return decorative_skip_result(
            ...
            fmt=self.format,
            parser_support="pptx_ooxml_decorative_flag",
